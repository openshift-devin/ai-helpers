...
This skill is automatically invoked by the `/create feature` command to guide the feature creation process.
...
**Input:**
```bash
/create feature CNTRLPLANE "Advanced hosted control plane observability"
```
...
**Input:**
```bash
/create feature CNTRLPLANE "Multi-cloud cost optimization for ROSA and ARO HCP"
```
