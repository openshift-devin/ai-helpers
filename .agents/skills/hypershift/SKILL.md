...
**Input:**
```bash
/create story CNTRLPLANE "Enable automatic node pool scaling for ROSA HCP"
```
...
**Input:**
```bash
/create bug "ARO HCP control plane pods crash on upgrade"
```
...
**Input:**
```bash
/create epic CNTRLPLANE "Improve HyperShift operator observability"
```
...
**Input:**
```bash
/create feature CNTRLPLANE "Advanced observability for ROSA and ARO HCP"
```
...
**Input:**
```bash
/create story CNTRLPLANE "Improve control plane pod scheduling"
```
...
/create story CNTRLPLANE "Enable autoscaling for ROSA HCP" --component "HyperShift"
```
