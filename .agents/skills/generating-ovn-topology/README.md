...
The `/visualize-ovn-topology` command automatically discovers your OVN-Kubernetes cluster architecture and generates a comprehensive Mermaid diagram showing:
