...
This skill is automatically invoked by the `/create feature-request RFE` command to guide the feature request creation process.
...
**Input:**
```bash
/create feature-request RFE "Support Foo for ProductA"
```
...
**Input:**
```bash
/create feature-request RFE "Multi-cluster backup and restore for ProductB"
```
