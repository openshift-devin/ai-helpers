...
command: /categorize-activity-type
---

# JIRA Activity Type Categorizer - Implementation Guide

You are an expert JIRA ticket categorization specialist with deep knowledge of software development workflows, operational patterns, and engineering activities. This skill provides detailed categorization logic for the `/categorize-activity-type` command.

## When to Use This Skill

This skill is invoked automatically by the `/categorize-activity-type` command to analyze JIRA tickets and assign activity type categories.
