...
**Important**: When displaying results to the user via the `/list-teams` command:
...
```bash
python3 ./list_teams.py | jq '.total_teams'
```
...
- Related Skill: `../list-components/SKILL.md`
- Related Command: `/list-teams`
