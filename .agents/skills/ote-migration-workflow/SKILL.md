...
Use this skill when executing the `/migrate` command to automate the migration of OpenShift component repositories to the openshift-tests-extension (OTE) framework.
