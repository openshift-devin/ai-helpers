...
This skill is automatically invoked by the `/create story` command to guide the story creation process.
...
- [Wiki Markup Reference](../../plugins/jira/reference/wiki-markup.md) - JIRA formatting syntax
- [MCP Tools Reference](../../plugins/jira/reference/mcp-tools.md) - MCP tool signatures and custom fields
- [CLI Fallback Reference](../../plugins/jira/reference/cli-fallback.md) - jira-cli commands (only if MCP unavailable)
...
For complete JIRA Wiki Markup formatting reference, see [Wiki Markup Reference](../../plugins/jira/reference/wiki-markup.md).
...
**Input:**
```bash
/create story MYPROJECT "Add user dashboard"
```
...
**Input:**
```bash
/create story CNTRLPLANE "Enable pod disruption budgets for ROSA HCP control plane"
```
...
**Input:**
```bash
/create story CNTRLPLANE "Add scaling metrics to observability dashboard" --parent CNTRLPLANE-100
```
...
**See:** `/create` command documentation for complete parent linking implementation strategy
